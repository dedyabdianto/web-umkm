...
<head>
    ...
    <title>{{ $title ?? 'UMKM Yanggandur' }}</title>
...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="/index" wire:navigate @if(url()->current() == route('index')) class="active" @endif>Beranda</a></li>
                            <li><a href="/front-produk" wire:navigate @if(url()->current() == route('front.produk')) class="active" @endif>Produk</a></li>
                            <li><a href="/tentang" wire:navigate>Tentang</a></li>
    ...
    {{ $slot }}
    {{-- <livewire:index>
    <livewire:front.produk-front>
    <livewire:front.tentang> --}}
